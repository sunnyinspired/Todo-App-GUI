...
add_button = App.Button(key="Add Todo", image_source="resources/add.png",
                        button_color="#64748c", mouseover_colors="Lavender")
    ...
    match event:
        case "Add Todo":
            ...
            if value["todo"] != "":
                ...
                App.popup("Please enter a Todo Item!", font=("Ubuntu", 12))
        case "Edit Todo":
            try:
